					...
					<div className="flex flex-row justify-evenly items-center w-full h-[56px]">
						<a href="/discover">
							<button className="group flex flex-col justify-center items-center gap-[4px] ">
								<div className="h-[20px] flex items-center justify-center">
									<i
										className="ri-fire-line text-[20px] transition-colors duration-125 ease-in-out group-active:text-textSecondary text-textTertiary"
										style={{ fontSize: "20px" }}
									></i>
								</div>
								<span className="text-[12px] leading-[16px] font-medium transition-colors duration-125 ease-in-out group-active:text-textPrimary text-textTertiary">
									Trending
								</span>
							</button>
						</a>
						<a href="/trackers?chain=sol">
							<button className="group flex flex-col justify-center items-center gap-[4px] ">
								<div className="h-[20px] flex items-center justify-center">
									<i
										className="ri-radar-line text-[20px] transition-colors duration-125 ease-in-out group-active:text-textSecondary text-textTertiary"
										style={{ fontSize: "20px" }}
									></i>
								</div>
								<span className="text-[12px] leading-[16px] font-medium transition-colors duration-125 ease-in-out group-active:text-textPrimary text-textTertiary">
						...
						<a href="/pulse?chain=sol">
							<button className="group flex flex-col justify-center items-center gap-[4px] ">
								<div className="h-[20px] flex items-center justify-center">
									<i
										className="ri-pulse-line text-[20px] transition-colors duration-125 ease-in-out group-active:text-textSecondary text-textPrimary"
										style={{ fontSize: "20px" }}
									></i>
								</div>
								<span className="text-[12px] leading-[16px] font-medium transition-colors duration-125 ease-in-out group-active:text-textPrimary text-textPrimary">
									Pulse
								</span>
							</button>
						</a>
						<a href="/perpetuals?chain=sol">
							<button className="group flex flex-col justify-center items-center gap-[4px] ">
								<div className="h-[20px] flex items-center justify-center">
									<i
										className="ri-exchange-line text-[20px] transition-colors duration-125 ease-in-out group-active:text-textSecondary text-textTertiary"
										style={{ fontSize: "20px" }}
									></i>
								</div>
								<span className="text-[12px] leading-[16px] font-medium transition-colors duration-125 ease-in-out group-active:text-textPrimary text-textTertiary">
						...
						<a href="/portfolio?chain=sol">
							<button className="group flex flex-col justify-center items-center gap-[4px] ">
								<div className="h-[20px] flex items-center justify-center">
									<i
										className="ri-folder-user-line text-[20px] transition-colors duration-125 ease-in-out group-active:text-textSecondary text-textTertiary"
										style={{ fontSize: "20px" }}
									></i>
								</div>
								<span className="text-[12px] leading-[16px] font-medium transition-colors duration-125 ease-in-out group-active:text-textPrimary text-textTertiary">
